...
class Basic_class extends Component {
    constructor(props) {
        super(props);
    }
    render() {
        return <div id="header_box">
            <div id="head_part" >
                <div className='left' style={{ width: "50%", }}>
                    <h2 style={{ margin: "0", color: "red", fontSize: "32px" }}>NETFLIX</h2>
                </div>
            ...
            <h1 style={{color:"white",fontSize:"52px"}}>Unlimited movies, TV shows and more.</h1>
            <h2 style={{color:"white",fontWeight:"normal"}}>Watch anywhere. Cancel anytime.<br/>Ready to watch? Enter your email to create or restart your membership.</h2>
            <div id="email_box">
                 ...
                 <div className='email_button'>
                    <span >
                        <button id="get">Get Started 
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="Hawkins-Icon Hawkins-Icon-Standard" data-name="ChevronRight"><path fill-rule="evenodd" clip-rule="evenodd" d="M7.29297 19.2928L14.5859 12L7.29297 4.70706L8.70718 3.29285L16.7072 11.2928C16.8947 11.4804 17.0001 11.7347 17.0001 12C17.0001 12.2652 16.8947 12.5195 16.7072 12.7071L8.70718 20.7071L7.29297 19.2928Z" fill="currentColor"></path></svg>
                        </button>
                    </span>
                 </div>
               </div>
